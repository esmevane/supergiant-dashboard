...
class NewComponent extends React.Component {
  static fetchData = params => appActions.get(params.appId)
...
function mapStateToProps(state, props) {
  const app = crud.getRecord(state.get('apps'), props.params.appId)
...
function mapDispatchToProps(dispatch, props) {
  const scope = `${props.params.appId}-new-component`
