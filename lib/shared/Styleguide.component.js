  ...
  render() {
    return(
      <section>
        ...
        <p>
          Supergiant comes prepackaged with a mildly configured Bitters install, demonstrated on this page.
        </p>
        <p>
          The purpose of this HTML is to help demonstrate the default Supergiant + Bitters styles, and to make sure that all possible HTML Elements are included in this HTML so as to not miss any possible Elements when designing a site.
        </p>
