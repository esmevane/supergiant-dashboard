...
import ComponentContainers from './ComponentContainers.container'
import ComponentVolumes from './ComponentVolumes.container'
import { backgroundPlanet } from '../visuals/backgroundPlanet'


export default class ShowComponent extends React.Component {
  componentDidMount() { backgroundPlanet.start() }
  componentWillUnmount() { backgroundPlanet.stop() }
    ...
    return(
      <div className='component'>
        ...
        <div className='component-detail-resources'>
          <ComponentContainers component={ component } app={ app } />
          <ComponentVolumes component={ component } app={ app } />
        </div>
