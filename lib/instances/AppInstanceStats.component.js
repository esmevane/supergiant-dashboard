...
import TextNoteDiv from '../elements/TextNoteDiv.component'
import DetailStat from '../elements/DetailStat.component'
...
export default class AppInstanceStats extends React.Component {
  ...
  resourcesFound() {
    ...
    return(
      <span>
        <DetailStat>
          <div>{ app.displayName && app.displayName() }</div>
          <TextNoteDiv>{ app.name }</TextNoteDiv>
        </DetailStat>
        <DetailStat>
          <div>
          ...
          <TextNoteDiv>CPU usage</TextNoteDiv>
        </DetailStat>
        <DetailStat>
          <div>
          ...
          <TextNoteDiv>RAM usage</TextNoteDiv>
        </DetailStat>
      </span>
    )
  }
