...
export default class ShowInstance extends React.Component {
      ...
      <section>
        <header className='context-header'>
          ...
          <div className='context-menu'>
            <button className='with-glyph glyph-right-arrow'>Open Terminal</button>
            <button className='with-glyph glyph-right-arrow'>View Logs</button>
          </div>
        </header>
            ...
            <section className='context-data'>
              <header>
                ...
                <menu className='context-menu'>
                  <button className='with-glyph glyph-right-arrow'>New</button>
                </menu>
              </header>
