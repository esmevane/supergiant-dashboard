      ...
      <section>
        <header className='context-header'>
          ...
          <div className='context-menu'>
            <button className='glyph-right-arrow'>Open Terminal</button>
            <button className='glyph-right-arrow'>View Logs</button>
          </div>
        </header>
            ...
            <section className='context-data'>
              <header>
                ...
                <menu className='context-menu'>
                  <button className='glyph-right-arrow'>New</button>
                </menu>
              </header>
