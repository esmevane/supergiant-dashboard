    ...
    apps: [
      {
        ...
        metadata: {
          tags: [{ name: `name`, value: `Qbox Development` }]
        },
        components: [
          {
            name: "elasticsearch",
            instances: 3,
            metadata: {
              tags: [{ name: `name`, value: `Elasticsearch` }]
            },
            blueprint: {
              containers: [
                {
                  ...
                  env: [
                    ...
                    { name: `NODE_NAME`, value: `SG_TEST_({ instance_id })` },
              ...
              volumes: [
                {
                  metadata: {
                    tags: [
                      { name: `name`, value: `Elasticsearch Data` }
                    ]
                  },
