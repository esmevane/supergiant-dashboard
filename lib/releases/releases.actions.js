...
export const GetTarget = "releases:get:target"
export const GetCurrent = "releases:get:current"
...
export const getTarget = (appName, componentName) => (
  { type: GetTarget, appName, componentName }
)

export const getCurrent = (appName, componentName) => (
  { type: GetCurrent, appName, componentName }
)
...
export const Clear = "releases:clear"
...
export const clear = (appName, componentName) => (
  { type: Clear, appName, componentName }
)
